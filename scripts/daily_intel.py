...
<body style="font-family:Arial,sans-serif;max-width:750px;margin:0 auto;background:#f5f5f5;padding:20px">
    ...
    <div style="background:#ffffff;padding:24px 20px;border-radius:0 0 8px 8px">
        ...
        <table style="width:100%;border-collapse:collapse">
            <tr style="background:#f8f8f8"><th style="padding:8px 10px;text-align:left"></th><th style="padding:8px 10px;text-align:center">All Time</th>{"<th style='padding:8px 10px;text-align:center'>Yesterday</th>" if ss.get('daily_delta_interactions') is not None else ""}{"<th style='padding:8px 10px;text-align:center'>This Week</th>" if ss.get('weekly_delta_interactions') is not None else ""}</tr>
            <tr><td style="padding:6px 10px">Total Interactions</td><td style="padding:6px 10px;font-weight:bold;text-align:center">{ss['total_interactions']}</td>{"<td style='padding:6px 10px;font-weight:bold;text-align:center'>" + str(ss['daily_delta_interactions']) + "</td>" if ss.get('daily_delta_interactions') is not None else ""}{"<td style='padding:6px 10px;font-weight:bold;text-align:center'>" + str(ss['weekly_delta_interactions']) + "</td>" if ss.get('weekly_delta_interactions') is not None else ""}</tr>
            <tr><td style="padding:6px 10px">Unique Budtenders</td><td style="padding:6px 10px;font-weight:bold;text-align:center">{ss['unique_employees']}</td>{"<td style='padding:6px 10px;font-weight:bold;text-align:center'>" + str(ss['daily_delta_employees']) + "</td>" if ss.get('daily_delta_employees') is not None else ""}{"<td style='padding:6px 10px;font-weight:bold;text-align:center'>" + str(ss['weekly_delta_employees']) + "</td>" if ss.get('weekly_delta_employees') is not None else ""}</tr>
            <tr><td style="padding:6px 10px">Unique Retailers</td><td style="padding:6px 10px;font-weight:bold;text-align:center">{ss['unique_retailers']}</td></tr>
            <tr><td style="padding:6px 10px">Published Snaps</td><td style="padding:6px 10px;font-weight:bold;text-align:center">{ss['total_snaps']}</td></tr>
        </table>
